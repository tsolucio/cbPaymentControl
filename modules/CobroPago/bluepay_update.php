...
$modCobroPago->addLink(
'DETAILVIEWBASIC',
'Receive BluePay Payment',
'javascript:receivePayment($RECORD$);'
);
...
$adb->query("update vtiger_eventhandlers set is_active=0 where handler_class='PaymentBenefit'");
